...
![[img_data_explo_bronze_crm_cust_info.png]]



## crm prd info

![[img_data_explo_bronze_crm_prd_info.png]]
## crm sales details

![[img_data_explo_bronze_crm_sales_details.png]]
...
## erp cust az12
![[img_data_explo_bronze_erp_cust_az12.png]]
cid seems to be connected to the cst_key from crm cust info. 

## erp loc a101

![[img_data_explo_bronze_erp_loc_a101.png]]
## erp px cat g1v2 
![[img_data_explo_bronze_erp_px_cat_g1v2.png]]

partial match between id from erp px cat g1v2 and prd_key in crm prd info 

![[img_data_explo_bronze_erp_px_cat_g1v2_with_crm_prd_info.png]]
